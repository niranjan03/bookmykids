      ...
      <div className="col-md-6 col-lg-4">
        ...
        <div className="card bg-dark text-white">
          <div className="card-body">
            <h2 className="card-title mb-4 text-center text-danger ">Sign Up</h2>
            <form>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input type="password" className="form-control bg-secondary text-white" id="password" />
              </div>
              <div className="mb-3 form-check">
                <input type="checkbox" className="form-check-input" id="remember" />
                <label className="form-check-label" htmlFor="remember">Remember Me</label>
              </div>
              <Link to={'/Profile'}><button type="submit" className="btn btn-danger w-100 mb-3">Sign In</button></Link>
            </form>
